...
public class ApplicationConstants {
    ...
    public static final String TEST_CURRENT_ADRESS = "London 12";
    public static final String TEST_PERMANENT_ADRESS = "KYIV 18";
    //menuItems
    public static final String MENU_LIST_TEXT_BOX = "Text Box";
