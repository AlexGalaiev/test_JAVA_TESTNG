...
public class ApplicationLocators {
 public static final String ADD_BTN = "#addNewRecordButton";
 public static final String REG_FORM = ".modal-content";
 public static final String REG_FORM_FIRST_NAME = "#firstName";
 public static final String REG_FORM_LAST_NAME = "#lastName";
 public static final String REG_FORM_EMAIL = "#userEmail";
